...
import { LogOut, Pencil, BookOpen, Settings } from 'lucide-react'
...
interface EmpresaData {
  ...
  phone: string
  email: string
  weekly_waste_amount: string
  collection_infrastructure: string
...
export default function EmpresaDashboard() {
  ...
  const [dados, setDados] = useState<EmpresaData | null>(null)
  ...
  useEffect(() => {
    const carregar = async () => {
      if (usuario) {
        ...
        if (data) setDados(data as EmpresaData)
      }
    }
